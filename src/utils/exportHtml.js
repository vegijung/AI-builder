    ...
    <div style="display:flex;gap:20px;flex-wrap:wrap;margin-bottom:16px;">
      <div style="flex:1;min-width:160px;">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
          ...
          <strong style="font-size:13px;color:#fff;">Free Assessment Review</strong>
        </div>
        <div style="font-size:11px;color:#b0aca8;padding-left:30px;">An MMG consultant reviews your results and prepares a tailored briefing.</div>
      </div>
      <div style="flex:1;min-width:160px;">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
          <span style="display:inline-flex;width:22px;height:22px;border-radius:50%;background:#FBB74025;color:#FBB740;font-size:12px;font-weight:900;align-items:center;justify-content:center;">2</span>
          <strong style="font-size:13px;color:#fff;">30-Min Strategy Call</strong>
        </div>
        <div style="font-size:11px;color:#b0aca8;padding-left:30px;">We walk through your top opportunities and discuss feasibility.</div>
      </div>
      <div style="flex:1;min-width:160px;">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
          <span style="display:inline-flex;width:22px;height:22px;border-radius:50%;background:#FBB74025;color:#FBB740;font-size:12px;font-weight:900;align-items:center;justify-content:center;">3</span>
          <strong style="font-size:13px;color:#fff;">Custom Roadmap</strong>
        </div>
        <div style="font-size:11px;color:#b0aca8;padding-left:30px;">Receive a detailed implementation plan with timelines and quick wins.</div>
      </div>
    </div>
    <div style="border-top:1px solid #3a3530;padding-top:14px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;">
      <div>
        <div style="font-size:13px;font-weight:700;color:#FBB740;">Book a Free Strategy Session</div>
        <div style="font-size:12px;color:#b0aca8;">janis.locher@mmgmc.ch &middot; www.mmgmc.ch</div>
      </div>
      <div style="font-size:11px;color:#8a8580;">
        50+ AI engagements &middot; 6 industries &middot; Avg. 8-12 weeks to value
      </div>
    </div>
  </div>`;
...
<head>
  ...
  <style>${MMG_STYLES}
    .cover-stats { display:flex; gap:24px; margin-top:12px; }
    .cover-stat { text-align:center; }
    .cover-stat-value { font-size:28px; font-weight:900; color:#FBB740; }
    .cover-stat-label { font-size:11px; color:#94A3B8; margin-top:2px; }
  </style>
</head>
<body>
  <div class="header">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:16px;">
      <div>
        ...
        <div class="subtitle">${date} &middot; Prepared by MMG Management Consulting</div>
      </div>
      <div class="cover-stats">
        <div class="cover-stat">
          <div class="cover-stat-value">${(readinessScore || 0).toFixed(1)}</div>
          <div class="cover-stat-label">Readiness Score</div>
        </div>
        <div class="cover-stat">
          <div class="cover-stat-value">${(recommendations || []).length}</div>
          <div class="cover-stat-label">Recommendations</div>
        </div>
        <div class="cover-stat">
          <div class="cover-stat-value">${areaCount}</div>
          <div class="cover-stat-label">Areas Assessed</div>
        </div>
      </div>
    </div>
    <div class="accent"></div>
  ...
  <div class="footer">
    ...
    <div>
      <a href="mailto:janis.locher@mmgmc.ch" style="color:#5B8AC4;">janis.locher@mmgmc.ch</a> &middot;
